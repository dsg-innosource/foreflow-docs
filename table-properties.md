...
The **Tags** section lets you add searchable words to your table. For example, if you wanted to find the Employees table, you might add the **Tag** _ADMIN_ followed by the **Enter** key. After that, you could add the **Tag** _HUMAN RESOURCES_ followed by the **Enter** key. This would provide your table with a searchable set of **Tags**.
